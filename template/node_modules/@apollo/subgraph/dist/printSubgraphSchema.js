...
function printSchemaDirectives(schema) {
...
function printFederationDirectives(element) {
    const federationDirectivesOnElement = (0, directives_1.gatherDirectives)(element)
