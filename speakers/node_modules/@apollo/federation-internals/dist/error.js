...
exports.REMOVED_ERRORS = exports.ERRORS = exports.ERROR_CATEGORIES = exports.withModifiedErrorNodes = exports.withModifiedErrorMessage = exports.errorCodeDef = exports.errorCode = void 0;
...
const NON_REPEATABLE_DIRECTIVE_ARGUMENTS_MISMATCH = makeCodeDefinition('NON_REPEATABLE_DIRECTIVE_ARGUMENTS_MISMATCH', 'A non-repeatable directive is applied to a schema element in different subgraphs but with arguments that are different.');
