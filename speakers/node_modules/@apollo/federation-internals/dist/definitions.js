...
class CoreFeature {
    ...
    directiveNameInSchema(name) {
        ...
        return elementImport ? ((_b = (_a = elementImport.as) === null || _a === void 0 ? void 0 : _a.slice(1)) !== null && _b !== void 0 ? _b : name) : this.nameInSchema + '__' + name;
    }
...
class Schema {
    ...
    toGraphQLJSSchema(isSubgraph = false) {
        ...
        const ast = (0, graphql_1.parse)((0, print_1.printSchema)(this, { ...print_1.defaultPrintOptions, mergeTypesAndExtensions: true }), { noLocation: true });
    ...
    *allSchemaElement() {
    ...
    getBuiltInDirective(schema, name) {
